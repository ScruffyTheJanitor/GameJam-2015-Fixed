...
public class Hearts extends PowerUp{
	
	public Hearts(float x, float y){
		this.id = PUID.Hearts;
		this.x = x;
		this.y = y;
		Texture heartTexture = new Texture("gui/gui_heart_full.png");
	...
	public void create(World world) {
		...
		rect.setAsBox(8 / Constants.PPM, 8 / Constants.PPM);
